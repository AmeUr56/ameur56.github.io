export const siteConfig = {
  ...
  skills: [
  "Python", "Java", "C", "Matlab", "Regex",
  "Machine Learning", "Deep Learning", "CV", "NLP", "Time Series Forecasting",
  "LangChain", "HuggingFace",
  "Temporal", "Prefect", "n8n",
  "TensorFlow", "Keras", "FastAPI", "Flask", "Rasa", "Locust", "Docker", "Nginx",
  "SQL", "MySQL", "SQLite", "NeonDB", "Supabase", "Pandas", "Matplotlib", "Seaborn", "Web Scraping",
  "API Development", "CLI & Shell Tooling", "Git & GitHub", "Project Management",
  "Canva",
  "Prompt Engineering", "Problem Solving", "Collaboration & Leadership", "Technical Communication", "Research"
],
  projects: [
    {
